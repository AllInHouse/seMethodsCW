...
| 17  | All the capital cities in the world organised by largest population to smallest.                            | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?limNum=          | 
| 18  | All the capital cities in a continent organised by largest population to smallest.                          | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?limNum=          | 
| 19  | All the capital cities in a region organised by largest to smallest.                                        | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?limNum=          | 
| 20  | The top N populated capital cities in the world where N is provided by the user.                            | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?limNum=          | 
