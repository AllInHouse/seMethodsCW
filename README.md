...
|  5  | The top N populated countries in a continent in the world where N is provided by the user.                  | Yes. | ![Example Image](img/allinhouse.jpeg) | top_populated_countries_continent?continent=&limNum=   | 
|  6  | The top N populated countries in a region in the world where N is provided by the user.                     | No.  | ![Example Image](img/allinhouse.jpeg) | top_populated_countries_continent?region=&limNum=          | 
...
| 13  | The top N populated cities in a continent where N is provided by the user.                                  | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?continent=&limNum=          | 
| 14  | The top N populated cities in a region where N is provided by the user.                                     | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?region=&limNum=          | 
| 15  | The top N populated cities in a country where N is provided by the user.                                    | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?limNum=          | 
| 16  | The top N populated cities in a district where N is provided by the user.                                   | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?district=&limNum=          | 
...
| 21  | The top N populated capital cities in a continent where N is provided by the user.                          | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?continent=&limNum=          | 
| 22  | The top N populated capital cities in a region where N is provided by the user.                             | No.  | ![Example Image](img/allinhouse.jpeg) | cities_largest_to_smallest_limited?region=&limNum=          | 
